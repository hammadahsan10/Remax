                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-gray-700 leading-relaxed">
                                RE/MAX® is built on a culture of giving. For over 32 years, RE/MAX has partnered with Children's Miracle Network Hospitals to change kids' health to change the future in communities across the U.S. and Canada.
                            </p>
                        </div>
